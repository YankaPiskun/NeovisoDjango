# Generated by Django 4.0.1 on 2022-06-05 08:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='noone@email.com', max_length=254, verbose_name='Почта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('manufacturer', models.CharField(default='', max_length=255, verbose_name='производитель')),
                ...
                ('owner', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='service.customer', verbose_name='владелец')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service.car', verbose_name='Машина')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service.employee', verbose_name='Сотрудник')),
            ],
            options={
                'ordering': ['-created_at'],
            },
